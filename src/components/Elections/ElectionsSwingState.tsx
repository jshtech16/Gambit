                            ...
                            <div className="flex flex-col gap-[10px]">
                                {
                                    ele.child.map((element, jdx) => (
                                        <div className="flex items-center gap-[10px] bg-[rgba(217,217,217,0.2)] rounded-md h-[45px] px-4 relative">
                                            ...
                                            <img src={element.img} alt="" className="w-[20px] lg:w-[30px] h-[20px] lg:h-[30px] relative" />
