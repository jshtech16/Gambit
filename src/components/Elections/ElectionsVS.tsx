        ...
        <div className="bg-[rgba(255,255,255,0.1)] w-full flex justify-between px-[50px] py-[27px] mt-[20px] lg:mt-[30px] rounded-[20px]">
            <div className="flex gap-[20px]">
                <div className="flex flex-col items-center gap-[10px]">
                    <img src="/assets/img/trump.png" alt="" className="w-[50px] lg:w-[150px]" />
            ...
            <div className="flex flex-col justify-center items-center">
                <img src="/assets/img/logo.png" alt="" className="w-[35px] lg:w-[110px]" />
            ...
            <div className="flex gap-[20px]">
                ...
                <div className="flex flex-col items-center gap-[10px]">
                    <img src="/assets/img/haris.png" alt="" className="w-[50px] lg:w-[150px]" />
