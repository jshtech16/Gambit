const Carousel = () => {
    return (
        <div className="flex justify-start 2xl:justify-center gap-5 pt-6 overflow-x-scroll hide-scroll">
            <div className="relative flex-1 min-w-[350px] max-w-[370px] bg-[linear-gradient(135deg,_#BFF816_-100%,_#2B2B2B_50%,_#6C3DB8_200%)] rounded-lg flex flex-col items-center justify-center px-5 py-3">
            ...
            <div className="relative flex-1 min-w-[350px] max-w-[370px] bg-[linear-gradient(135deg,_#6C3DB8_-100%,_#2B2B2B_50%,_#BFF816_200%)] rounded-lg flex flex-col items-center justify-center px-5 py-3">
            ...
            <div className="flex-1 min-w-[350px] max-w-[370px] bg-[linear-gradient(135deg,_#BFF816_-100%,_#2B2B2B_50%,_#6C3DB8_200%)] flex justify-center items-center px-5 py-3 rounded-lg">
                <div>
            ...
            <div className="flex-1 min-w-[350px] max-w-[370px] bg-[linear-gradient(135deg,_#6C3DB8_-50%,_#4E4E4E_100%)] rounded-lg flex justify-center items-center gap-3 px-5 py-3">
