...
import NavbarTabMenu from "./NavbarTabMenu";
...
const Navbar = () => {
    ...
    return (
        <nav className="bg-black px-[20px] xl:px-[30px] py-[30px]" style={{ borderBottom: '0.5px solid', borderImage: 'linear-gradient(to right, #BFF816, #525252) 1' }}>
            <div className="mx-auto">
                <div className="relative flex h-[40px] items-center justify-between">
                    <div className="flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <Link href='/'>
                                <img className="h-8 w-auto cursor-pointer" src="/assets/img/logo.png" alt="" />
                            </Link>
                        </div>
                    </div>
                    <form className="hidden lg:block flex-1 mx-auto px-5 h-full">
                        <div className="relative h-full">
                            ...
                            <input type="search" id="navbar-search" className="block w-full h-full ps-10 text-sm text-[#424242] border border-[#424242] rounded-lg bg-black placeholder:text-[#424242] after:border-[#424242] focus-visible:outline-none" placeholder="Search Markets" required />
                        </div>
                    </form>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <div className="relative py-2" onMouseLeave={() => setIsMarketOpen(false)}>
                            <div className="hidden md:flex items-center flex-col gap-1 px-2 rounded-lg cursor-pointer hover:bg-[#252525] p-1"
                                ...
                                isMarketOpen && (
                                    <div className="absolute right-[-190px] z-10 bg-gradient-to-b from-[#0B0B0B] to-[#2A2A2A] rounded-lg w-[466px] mt-2 p-[20px] flex gap-[20px] flex-col" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" onMouseEnter={() => setIsMarketOpen(true)} onMouseLeave={() => setIsMarketOpen(false)}>
                                        ...
                                        <div className="flex gap-[20px]">
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                        ...
                                        <div className="flex gap-[20px]">
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                                ...
                                                <p className="text-white font-medium">Liquid</p>
                                            </div>
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                                <img src="/assets/img/icons/market-ending.svg" alt="" />
                                                <p className="text-white font-medium">Ending Soon</p>
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-end">
                                        ...
                                        <div className="flex gap-[20px]">
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                                ...
                                                <p className="text-white font-medium">Middle East</p>
                                            </div>
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                                <img src="/assets/img/icons/politics.png" alt="" />
                                                <p className="text-white font-medium">Politics</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-[20px]">
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                        ...
                                        <div className="flex gap-[20px]">
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                                                ...
                                                <p className="text-white font-medium">Pop Culture</p>
                                            </div>
                                            <div className="border border-white px-4 py-2 flex-1 rounded-lg flex items-center gap-4 cursor-pointer">
                            ...
                            isLogin ?
                                (
                                    <div className="flex items-center">
                                        <div className="hidden sm:flex items-center flex-col gap-1 px-2 rounded-lg cursor-pointer hover:bg-[#252525] p-1">
                        ...
                        <div className={`${isLogin ? 'py-2' : 'py-5'}`} onMouseLeave={() => setIsopen(false)}>
                            <div className="relative inline-block text-left">
                                {
                                    isLogin ? (
                                        <button type="button" className="hidden lg:flex items-center gap-2 hover:bg-[#252525] p-3 py-2 rounded-full" id="menu-button"
                                        ...
                                        <div className="hidden md:block px-2" onClick={() => setIsopen(!isopen)} onMouseEnter={() => setIsopen(true)}>
                                        ...
                                        <div className={`absolute right-0 z-10 bg-gradient-to-b from-[#0B0B0B] to-[#2A2A2A] rounded-lg w-[227px] ${isLogin ? 'mt-2' : 'mt-5'}`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" onMouseEnter={() => setIsopen(true)} onMouseLeave={() => setIsopen(false)}>
                                            {
                                                isLogin ? (
                                                    <div className="flex gap-2 items-center border-b border-[#535353] p-[20px]">
                                                        ...
                                                        <div>
                                                            <p className="text-white font-medium" style={{ lineHeight: '16px' }}>Edison</p>
                                            ...
                                            {
                                                isLogin &&
                                                <div className="flex gap-2 items-center border-t border-[#535353] p-[20px] cursor-pointer">
                                                    <p className="text-white font-medium" onClick={() => setIsLogin(false)}>Logout</p>
                                                </div>
                                            }
                                        </div>
                                    )
